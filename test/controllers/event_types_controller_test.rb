...
class EventTypesControllerTest < ActionController::TestCase
  ...
  test "should create event_type" do
    assert_difference('EventType.count') do
      post :create, event_type: { category_id: @event_type.category_id, description: @event_type.description, long_name: @event_type.long_name, name: @event_type.name }
    end
  ...
  test "should update event_type" do
    patch :update, id: @event_type, event_type: { category_id: @event_type.category_id, description: @event_type.description, long_name: @event_type.long_name, name: @event_type.name }
    assert_redirected_to event_type_path(assigns(:event_type))
  end
